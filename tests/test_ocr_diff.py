...
# ПРАВКА #75: 65 → 66. Новых расхождений прогонов нет: разведённые пробелом
# номера пунктов переразбили шумный п. 29 (pipeline перепутал там порядок
# ячеек) с четырёх опкодов на пять.
FIXTURE_FINDINGS = 66
