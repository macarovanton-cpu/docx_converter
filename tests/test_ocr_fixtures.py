...
# ПРАВКА #83: правка 11 спеки 00 (строка «с. Сафарово, 2026 г.» перед таблицей) число
# не меняет — четыре новых токена вливаются в уже существующий опкод
# replace ['Noп/п'] -> [..., '№', 'п/п'], отдельного insert difflib не создаёт.
# Разбор — в docs/docx_converter_docs_sync.md, «Метрика vlm→golden».
VLM_TO_GOLDEN_DIFFS = 99
# golden.md вне git — sha ловит тихую подмену эталона. ПРАВКА #83: пересобран с правкой 11.
GOLDEN_SHA256 = "86987973e1591eeefe136d27c7b8932b2fcdc7f1ff76f7bc733bb80dce536dc7"
